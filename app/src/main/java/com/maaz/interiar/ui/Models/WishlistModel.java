package com.maaz.interiar.ui.Models;
...
public class WishlistModel {
 ...
 /*   public WishlistModel(int productImage, String productTitle, int freeCoupens, String rating, int totalRatings, String productPrice, String cuttedPrice, String paymentMethod) {
    ...
    public WishlistModel(int productImage, String productTitle, String rating, int totalRatings, String productPrice, String cuttedPrice, String paymentMethod) {
        this.productImage = productImage;
        this.productTitle = productTitle;
        this.rating = rating;
        this.totalRatings = totalRatings;
