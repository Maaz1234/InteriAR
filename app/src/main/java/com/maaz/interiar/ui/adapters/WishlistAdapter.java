       ...
       /* private void setData(int resource, String title, int freeCoupensNo, String averageRate, int totalRatingsNo, String price, String cuttedPriceValue, String payMethod)
        {
            ...
            if (freeCoupensNo != 0)
            {
                coupenIcon.setVisibilty(View.VISIBLE);
                if (freeCoupensNo == 1)
                {
        ...
        private void setData(int resource, String title, String averageRate, int totalRatingsNo, String price, String cuttedPriceValue, String payMethod)
        {
            productImage.setImageResource(resource);
            productTitle.setText(title);
            rating.setText(averageRate);
